        ...
        for item in work {
            ...
            let mut payload = json!({
                ...
                "instructions": concat!(
                    ...
                    "If no credential works, use rpcclient_command with null_session=true for basic ",
                    "domain enumeration, then call task_complete with a concise summary if ACL data ",
                    "cannot be retrieved.\n\n",

...
```bash
# Tag the image
docker tag ares-lateral-movement-agent:latest ghcr.io/l50/ares-lateral-movement-agent:latest

# Authenticate with GHCR
echo $GITHUB_TOKEN | docker login ghcr.io -u YOUR_USERNAME --password-stdin

# Push the image
docker push ghcr.io/l50/ares-lateral-movement-agent:latest
```

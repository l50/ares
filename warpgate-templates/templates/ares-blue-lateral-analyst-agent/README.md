...
building **Docker images** (for `amd64` and `arm64`). The lateral analyst tracks
multi-host compromise and constructs lateral movement graphs, using a compiled Rust

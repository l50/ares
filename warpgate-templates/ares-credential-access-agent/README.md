...
Kerberos attack tools and credential dumping utilities using Ansible roles from the nimbus_range collection.
...
After the build, multi-arch Ares Credential Access Agent Docker images will be available
locally as `ares-credential-access-agent:latest`.

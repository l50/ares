...
lateral movement and credential extraction tools using Ansible roles from the nimbus_range collection.
...
After the build, multi-arch Ares Lateral Movement Agent Docker images will be available
locally as `ares-lateral-movement-agent:latest`.
